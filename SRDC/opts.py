...
def opts():
    ...
    parser.add_argument('--workers', type=int, default=2, metavar='N', help='number of data loading workers (default: 8)')
    ...
    parser.add_argument('--gray_tar_agree', action='store_false', help='whether to enforce the consistency between RGB and gray images on the target domain')
    parser.add_argument('--aug_tar_agree', action='store_false', help='whether to enforce the consistency between RGB and augmented images on the target domain')
    ...
    parser.add_argument('--pretrained', action='store_false', help='whether to use pretrained model')
    # i/o
