...
def main():
    ...
    learn_cen = Variable(torch.FloatTensor(args.num_classes, 8192).fill_(0))###cuda2048/8192
    learn_cen.requires_grad_(True)
    learn_cen_2 = Variable(torch.FloatTensor(args.num_classes, args.num_neurons * 4).fill_(0))###cuda
    ...
    src_cs = torch.FloatTensor(len(train_loader_source.dataset.tgts)).fill_(1) # initialize source weights########cuda
